...
### Graph Evaluation
Looking at the graphics, in order to see benefits of our clustering, we are looking for distinct groupings of universities in clusters 1, 2, and 3.  In our graphs, this appears as groupings of square, circle, and diamond points.  In all graphics, the cluster 2 observations are at the "front" of the data, with better values, cluster 1 observations are in the middle of the data, with average values, and cluster 3 observations are at the "back" of the data, with poorer values.  While there is overlap between the clusters, there is an overall distinct region for each of the cluster types, therefore suggesting that the clustering algorithm is effective.  
